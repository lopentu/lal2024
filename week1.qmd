...
# 歡迎加入語言解謎的世界
Decipher the World with Linguistics
...
::: {.callout-tip}
想像一個大部分的人都不需要為生活操心的世界，遊戲與娛樂將成為人類 (或AI 希望人類)的主要活動。這樣的世界將會是怎樣的呢？
...
<font color='blue'>unplugged computational-linguistic (algorithmic) thinking</font>

大型語言模型下的時代意義

- (Language) Game with a purpose

- in-context learning and <font color='red'>(anthropomorphized) prompt engineering</font>
...
- Core competence to **reasoning with small and unseen data**
    ...
    - 人類的強項不是大數據與統計計算
    - 而是基於小/厚數據的知識推理、直觀、解決問題、與文化想像的能力、情緒、多元價值與同理溝通
:::
...
> 從解碼、辨識與推導 (Decoding, Recognition and Inference) 到編碼 (Encoding) 能力學習
:::
...
- 這門課也是`台大計算語言學領域專長`的核心必修課程。
(程式設計與資料科學導論、語言的邏輯分析、計算語言學與語言理論、計算語言學專題)

## 暫時課綱

![](/pics/syllabus.png){width=100}
