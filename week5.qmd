...
- Content words (open class) vs function words (closed class).
    - Any psychological or neurological evidence? 

:::{.callout-warning title="以下句子有幾個 F 字母？"}
...
<small>
    boy (1), boy-ish (2), boy-ish-ness (3), gentle-man-li-ness (4), un-gentle-man-li-ness	(5)	
</small>

- Every word in every language is composed of one or more morphemes (bold hypothesis of discreteness!)

:::{.callout-tip title="not to confuse morphemes with syllables"}
...
## Exercise: 咒罵中綴 Expletive Infixation
...
![Flowchart for identifying morphemes](pics/mor_id.png){width=30%}
...
You are given words in Swahili: 

```
mtu, mbuzi, jito, mgeni, jitu and kibuzi. 
```

Their translations in a different order are: 
```
...
## Wordnet
`fine-grained word sense inventory`
...
「老」有幾個意思？「老鼠」的「老」是什麼？(`empty morpheme`?)
...
##
More data analysis and applications in AI context

[ROCLING 2023 tutorial](https://lopentu.github.io/CwnWeb/talks/#/)


## Sense tagger
[colab notebook](https://colab.research.google.com/drive/1ifMIy5ydH5BvxqCKqKg552I3ffv7fpD5?usp=sharing)
...
## [語法化](https://www.wikiwand.com/zh-tw/%E8%AF%AD%E6%B3%95%E5%8C%96) 
`虛化`

- 實詞 (content word) 語義在歷史的軌跡中，轉化為非實詞語義，並且該詞轉化為表語法功能為主的成分（即虛詞或稱功能詞）
的過程或現象。如漢語「把」「被」。

- 「那(個)」

  - <small> 從最原始的遠指指示代名詞 ("那(個)人")，到心理空間中較遠 ("你如果不喜歡，那我就不去")，到言談中換取思考時間的**填充詞** (filler) ("那個那個拍得很好")</small>

  - <small>那個我跟你說，我老公實在很那個，昨天那個來了他還要那個 </small>
...
> 不是我要說他，已經什麼都有了他還在那邊邱什麼邱。別人我不敢說，這種人喔實在是 $#* :-(


### AFTER

```{r echo=TRUE, message=FALSE, warning=FALSE}
tokens("不是我要說他，已經什麼都有了他還在那邊邱什麼邱。別人我不敢說，這種人喔實在是 $#* :-( $#*") 
``` 
...
- idiosyncratic linguistic unit that must be recorded in the lexicon.

- 記憶單位 (Memorized units:)：不拘大小，可以是語段、詞組、句子、成語、單詞、音段、聲調、子母音...
...
## 題目練習
<small>In Latvian a noun can be one of two genders; furthermore, adjectives agree with nouns in gender, number and case. You are given phrases in either the nominative or the genitive case with their translations:
